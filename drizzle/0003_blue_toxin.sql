...
DO $$ BEGIN
 ALTER TABLE "transactions" ADD CONSTRAINT "transactions_amount_id_accounts_id_fk" FOREIGN KEY ("amount_id") REFERENCES "accounts"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
